...
<body>
  <div class="container d-flex justify-content-center mt-5">
    <div class="col-6">
      <div class="row">
        <p class="display-5 fw-bold">Contact List</p>
      </div>
      <div class="row">
        <a href="add_contact.php" class="btn btn-outline-dark btn-sm">Add Contact&nbsp;<i class="fa-solid fa-plus"></i></a>
      </div>
      <?php
                ...
                <div class="col " style="text-align: right!important;">
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                      <li>
                        <a href="update_contact.php?id=<?= $row['id']; ?>" class="btn"><i class="fa-solid fa-pen-to-square"></i>&nbsp;Edit</a>
                      </li>
                      <li>
                        <a href="../handlers/delete_contact_handler.php?id=<?= $row['id']; ?>" class="btn"><i class="fa-solid fa-trash"></i>&nbsp;Delete</a>
                      </li>
                    </ul>
                  </div>
                </div>
